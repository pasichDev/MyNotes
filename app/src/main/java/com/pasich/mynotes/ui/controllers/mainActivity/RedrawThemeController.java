...
public class RedrawThemeController {
    ...
    public static void styleCard(MaterialCardView card, Context ctx) {
        int bg =
                MaterialColors.getColor(
                        ctx, com.google.android.material.R.attr.colorSurfaceContainer, Color.GRAY);
    ...
    public static void styleSwitch(MaterialSwitch sw, Context ctx) {
        int active =
                MaterialColors.getColor(
                        ctx, com.google.android.material.R.attr.colorPrimaryFixed, Color.GRAY);
        int inactive =
                MaterialColors.getColor(
                        ctx, com.google.android.material.R.attr.colorOnSurfaceVariant, Color.GRAY);
    ...
    public static void styleSlider(@NonNull Slider slider, @NonNull Context ctx) {
        int active =
                MaterialColors.getColor(
                        ctx, com.google.android.material.R.attr.colorPrimaryVariant, Color.GRAY);
    ...
    public static void styleTabs(@NonNull TabLayout tabs, @NonNull Context ctx) {
        ...
        int container =
                MaterialColors.getColor(
                        ctx, com.google.android.material.R.attr.colorSurface, Color.GRAY);
    ...
    private static void updateSwitchColors(MaterialSwitch sw, int primary, int surfaceVariant) {
        ...
        int[] thumbColors = {primary, Color.WHITE};
        sw.setThumbTintList(new ColorStateList(thumbStates, thumbColors));

        int[][] trackStates = {
            new int[] {android.R.attr.state_checked}, new int[] {-android.R.attr.state_checked}
        };
        int[] trackColors = {adjustAlpha(primary, 0.5f), adjustAlpha(surfaceVariant, 0.3f)};
