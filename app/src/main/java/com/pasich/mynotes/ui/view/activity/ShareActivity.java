...
/**
 * An activity that is a gateway to save a note via the save button or from text selection context
 * menu
 */
@AndroidEntryPoint
public class ShareActivity extends AppCompatActivity {

    @Inject SharedNoteCreator noteCreator;
    ...
    private void createNoteAndOpen(String text) {
        ...
        noteCreator.create(
                text,
                new SharedNoteCreator.Callback() {
                    @Override
                    ...
                    public void onError(Throwable error) {
                        Toast.makeText(ShareActivity.this, "Failed to save note", Toast.LENGTH_LONG)
                                .show();
                        finish();
                    }
                });
    ...
    private void openEditor(long noteId) {
        new NoteNavigator(this, themePreferencesCache)
                .openNote(noteId, true, "", null, null, false);
