...
@AndroidEntryPoint
public class DeleteTagDialog extends BaseDialogBottomSheets
        implements DeleteTagDialogContract.view {

    @Inject public DeleteTagDialogPresenter mPresenter;
    private Tag tag;
    ...
    public void onStart() {
        super.onStart();
        binding.deleteTagAndNotes.setVisibility(
                mPresenter.getCountNotesForTag() > 0 ? View.VISIBLE : View.GONE);
    }
    ...
    public void initListeners() {
        ...
        binding.deleteTagAndNotes.setOnClickListener(
                v -> {
