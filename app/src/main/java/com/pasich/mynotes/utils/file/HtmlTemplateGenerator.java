...
public class HtmlTemplateGenerator {
    ...
    public static String generateHtmlContent(
        ...
        html.append("<!DOCTYPE html>\n")
                ...
                .append(escapeHtml(exportFromText))
                .append(" ")
                .append(escapeHtml(currentDate))
                .append("</div>\n")
                .append("    </div>\n\n");
    ...
    private static void addNoteToHtml(StringBuilder html, String title, String content) {
        ...
        html.append("    <div class=\"note\">\n")
                .append("        <div class=\"note-title\">")
                .append(escapeHtml(noteTitle))
                .append("</div>\n")
                .append("        <div class=\"note-content\">")
