 ...
 *
 * <p>This is deliberately distinct from a transport failure. An object discovered after a lost HTTP
 * response can only confirm an ambiguous request; it can never turn a hash or size mismatch into
 * success.
 */
