...
public class BasePresenterSafetyTest extends BasePresenterTest {
    ...
    static class TestPresenter extends BasePresenter<BaseView> {
        ...
        TestPresenter(com.pasich.mynotes.utils.rx.SchedulerProvider sp,
    ...
    public void setUp() {
        initMocks(this);
        presenter = new TestPresenter(testSchedulerProvider(), new CompositeDisposable(), mockDataManager);
    }
